...
export default function CompanySaveBox() {
  ...
  const handleSubmit = async (event) => {
    ...
    await axios.post(`http://localhost:9070/api/v1/company/save/${token}`, payload)
      .then((response) => {
      ...
      {iseInformationBoxShown && (
        <Card>
          ...
          >
            ...
            <TextField id="companyBalanceStatus" name="companyBalanceStatus" label="Company BalanceStatus" variant="filled" value={companyBalanceStatus} />
            ...
            <Typography gutterBottom
              ...
              component="div"
            >Address</Typography>
            <TextField id="companyNeighbourhood" name="companyNeighbourhood" label="Neighbourhood" variant="filled" value={companyNeighbourhood} />
            <TextField id="companyDistrict" name="companyDistrict" label="District" variant="filled" value={companyDistrict} />
            <TextField id="companyProvince" name="companyProvince" label="Province" variant="filled" value={companyProvince} />
            <TextField id="companyCountry" name="companyCountry" label="Country" variant="filled" value={companyCountry} />
            <TextField id="companyBuildingNumber" name="companyBuildingNumber" label="BuildingNumber" variant="filled" value={companyBuildingNumber} />
            <TextField id="companyApartmentNumber" name="companyApartmentNumber" label="ApartmentNumber" variant="filled" value={companyApartmentNumber} />
            <TextField id="companyPostalCode" name="companyPostalCode" label="PostalCode" variant="filled" value={companyPostalCode} />
